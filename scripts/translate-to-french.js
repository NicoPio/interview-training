...
const translations = {
  ...
  'What are arrow functions in JavaScript?': 'Que sont les fonctions fléchées en JavaScript ?',
  'What is hoisting in JavaScript?': "Qu'est-ce que le hoisting en JavaScript ?",
  'What is Strict Mode in JavaScript?': "Qu'est-ce que le mode strict en JavaScript ?",
  'What is NaN?': "Qu'est-ce que NaN ?",
  ...
  'What is DOM?': "Qu'est-ce que le DOM ?",
  'What is BOM?': "Qu'est-ce que le BOM ?",
  'Explain about this keyword in JavaScript with an example.':
    'Expliquez le mot-clé this en JavaScript avec un exemple.',
  'What is scope in JavaScript?': "Qu'est-ce que la portée (scope) en JavaScript ?",
  'What is closure in JavaScript?': "Qu'est-ce qu'une fermeture (closure) en JavaScript ?",
  ...
  'What are prototypes in JavaScript?': 'Que sont les prototypes en JavaScript ?',
  ...
  'What are promises in JavaScript?': 'Que sont les promesses (promises) en JavaScript ?',
  'Explain rest parameter in JavaScript': 'Expliquez le paramètre rest en JavaScript',
  ...
  // HTML Questions
  'What is semantic HTML?': "Qu'est-ce que le HTML sémantique ?",
  'What is Semantic HTML?': "Qu'est-ce que le HTML sémantique ?",

  // CSS Questions
  'What is the box model?': "Qu'est-ce que le modèle de boîte (box model) ?",
  'What is the CSS Box Model?': "Qu'est-ce que le modèle de boîte CSS ?",
}
...
const contentTranslations = {
  ...
  'Primitive values include': 'Les valeurs primitives incluent',
  ...
  'Non-primitive values are objects': 'Les valeurs non-primitives sont des objets',
  ...
  'Examples to illustrate': 'Exemples pour illustrer',
  'Examples of': 'Exemples de',
  Common: 'Courants',
  ...
  Null: 'Null',
  Symbol: 'Symbole',
  'Represents numeric values': 'Représente les valeurs numériques',
  'Represents textual data': 'Représente les données textuelles',
  'Represents true or false': 'Représente vrai ou faux',
  ...
  'Represents a unique identifier': 'Représente un identifiant unique',

  // Operators and keywords
  'Using the': 'En utilisant',
  ...
  'Non-primitive types will typically return': 'Les types non-primitifs retourneront typiquement',
  "even though it's a primitive value": "même si c'est une valeur primitive",
  ...
  'allowing its reference': 'permettant sa référence',
  'but not its initial value': 'mais pas sa valeur initiale',
  'before the actual declaration line': 'avant la ligne de déclaration réelle',
  'Even though': 'Même si',
  'is defined after its call': 'est défini après son appel',
  ...
  'enabling its execution': 'permettant son exécution',
  'Hoisting also occurs within local scopes':
    'Le hoisting se produit également dans les portées locales',
  'like functions': 'comme les fonctions',
  'Here,': 'Ici,',
  'is hoisted to the top of the': 'est remonté vers le haut de la',
  function: 'fonction',
  ...
  'The example with': "L'exemple avec",
  'demonstrates this': 'le démontre',
  as: 'car',
  ...
  'Strict mode enforces declaration': 'Le mode strict impose la déclaration',
  Using: 'Utiliser',
  ...
  'They were introduced in ECMAScript 6': 'Elles ont été introduites dans ECMAScript 6',
  ...
  'In this': 'Dans cet',
  'the arrow function': 'la fonction fléchée',
  'takes two parameters': 'prend deux paramètres',
  'and returns their sum': 'et retourne leur somme',
  The: 'La',
  'syntax is used to define the function': 'syntaxe est utilisée pour définir la fonction',
  ...
  'you can omit the curly braces and the': 'vous pouvez omettre les accolades et le mot-clé',
  keyword: '',
  'Traditional Function Expression': 'Expression de fonction traditionnelle',
  'Arrow Function': 'Fonction fléchée',
  'Define an object': 'Définir un objet',
  'Define another object': 'Définir un autre objet',
  'Call the method': 'Appeler la méthode',
  'refers to the object calling the function': "fait référence à l'objet appelant la fonction",
  'returns the': 'retourne la',
  'property of': 'propriété de',
  'inside the function refers to the object':
    "à l'intérieur de la fonction fait référence à l'objet",
  'does not refer to': 'ne fait pas référence à',
  'Instead, it inherits its value from the parent scope':
    'Au lieu de cela, il hérite de sa valeur de la portée parente',
  'which is the global object': "qui est l'objet global",
  'window in a browser environment': 'window dans un environnement navigateur',
  'Consequently,': 'Par conséquent,',
  returns: 'retourne',
  undefined: 'undefined',
  'or may even throw an error': 'ou peut même lever une erreur',
  'is not defined in the global scope': "n'est pas défini dans la portée globale",
  'depending on the environment': "selon l'environnement",
  ...
  'Outer function scope': 'Portée de la fonction externe',
  'Inner function scope': 'Portée de la fonction interne',
  'Accessing both inner and outer variables': 'Accès aux variables internes et externes',
  'Inner Variable': 'Variable interne',
  'Outer Variable': 'Variable externe',
  ...
  'which is now a closure': 'qui est maintenant une fermeture',
  'Executing the closure function': 'Exécution de la fonction de fermeture',
  'defines an outer variable': 'définit une variable externe',
  'and an inner function': 'et une fonction interne',
  'has access to the variables of its outer function':
    'a accès aux variables de sa fonction externe',
  'creating a closure': 'créant une fermeture',
  'The returned': 'La',
  retournée: '',
  'retains access to the': "conserve l'accès à la",
  'even after': 'même après que',
  'has finished executing': "ait fini de s'exécuter",
  ...
  'rather than merely defining its appearance': 'plutôt que de simplement définir son apparence',
  ...
  'Instead of using divs for everything': "Au lieu d'utiliser des divs pour tout",
  'Use semantic elements': 'Utiliser des éléments sémantiques',
  'Common semantic HTML5 elements include': 'Les éléments HTML5 sémantiques courants incluent',
  'Introductory content': "Contenu d'introduction",
  'Navigation links': 'Liens de navigation',
  'Main content': 'Contenu principal',
  'Self-contained content': 'Contenu autonome',
  'Thematic grouping': 'Groupement thématique',
  'Sidebar content': 'Contenu de barre latérale',
  'Footer content': 'Contenu de pied de page',
  'Images with captions': 'Images avec légendes',
  ...
  Content: 'Contenu',
  'The actual content of the element': "Le contenu réel de l'élément",
  'text, images, etc': 'texte, images, etc',
  Padding: 'Remplissage',
  'Space between the content and the border': 'Espace entre le contenu et la bordure',
  Border: 'Bordure',
  'A line surrounding the padding and content': 'Une ligne entourant le remplissage et le contenu',
  Margin: 'Marge',
  ...
  'Space inside the border': "Espace à l'intérieur de la bordure",
  'Border around padding and content': 'Bordure autour du remplissage et du contenu',
  'Space outside the border': "Espace à l'extérieur de la bordure",
  'Total element size calculation': "Calcul de la taille totale de l'élément",
  ...
  bottom: 'bas',
  property: 'propriété',
  'Box-sizing': 'Dimensionnement de boîte',
  ...
  'either primitive or non-primitive': 'soit primitives soit non-primitives',
  ...
  Attribute: 'Attribut',
  Scope: 'Portée',
  'Functional scope': 'Portée fonctionnelle',
  'Block scope': 'Portée de bloc',
  'Update/Re-declaration': 'Mise à jour/Re-déclaration',
  ...
  'Declaration without Initialization': 'Déclaration sans initialisation',
  'Can be declared without being initialized': 'Peut être déclaré sans être initialisé',
  'Cannot be declared without being initialized': 'Ne peut pas être déclaré sans être initialisé',
  'Access without Initialization': 'Accès sans initialisation',
  ...
  'JavaScript is a dynamically typed language': 'JavaScript est un langage à typage dynamique',
  ...
  'Taking one or more functions as arguments': 'Prenant une ou plusieurs fonctions comme arguments',
  'Returning a function as a result': 'Retournant une fonction comme résultat',
  'Common Examples of Built-in HOFs': 'Exemples courants de HOF intégrées',
  'map():': 'map() :',
  ...
  'Creating Custom HOFs': 'Créer des HOF personnalisées',
  ...
  'Conversion in Operations': 'Conversion dans les opérations',
  'Assignment value indicating no object': "Valeur d'affectation indiquant aucun objet",
  'variable declared but not yet assigned a value':
    'variable déclarée mais pas encore affectée une valeur',
  'primitive value representing Null/empty': 'valeur primitive représentant Null/vide',
  'primitive value used when a variable is unassigned':
    "valeur primitive utilisée quand une variable n'est pas affectée",
  'Absence of a value for a variable': "Absence d'une valeur pour une variable",
  'Indicates the absence of the variable itself': "Indique l'absence de la variable elle-même",
  'Converted to zero': 'Converti en zéro',
  'Converted to NaN during primitive operations': 'Converti en NaN lors des opérations primitives',
  ...
  'Method Invocation:': 'Invocation de méthode :',
  ...
  'It only depends on its input arguments': "Elle ne dépend que de ses arguments d'entrée",
  ...
  'Impure Function:': 'Fonction impure :',
  ...
  'Create two Person objects:': 'Créer deux objets Person :',
  ...
  'Example of Callback Hell:': 'Exemple de Callback Hell :',
  ...
  'Syntax for creating a Promise': 'Syntaxe pour créer une promesse',
  'Perform asynchronous operations': 'Effectuer des opérations asynchrones',
  ...
  'which, in turn, accepts two parameters': 'qui, à son tour, accepte deux paramètres',
  ...
  'or rejected by calling': 'ou rejetée en appelant',
  ...
  pending: 'en attente',
  settled: 'établie',
  'The action related to the promise succeeded': "L'action liée à la promesse a réussi",
  'The action related to the promise failed': "L'action liée à la promesse a échoué",
  ...
  'Valid Example:': 'Exemple valide :',
  'Invalid Example:': 'Exemple invalide :',
  ...
  'The generator can be resumed later': 'Le générateur peut être repris plus tard',
  ...
  'Function Declaration:': 'Déclaration de fonction :',
  ...
  'Function Expression:': 'Expression de fonction :',
  ...
  '3. process.nextTick:': '3. process.nextTick :',
  ...
  'Example 2:': 'Exemple 2 :',
  'Example 3:': 'Exemple 3 :',
  'Variable Hoisting': 'Remontée de variable',
  'Function Hoisting': 'Remontée de fonction',
  'Example:': 'Exemple :',
}
